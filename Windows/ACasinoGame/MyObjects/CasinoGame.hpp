...
public:
	 ...
	 */
	CasinoGame(std::shared_ptr<WindowModel> windowModel);
	 ...
	 */
	 //WARNING: Not tested
	void switchToWindow(std::shared_ptr<WindowModel> windowModel);
...
private:
	...
	std::map<std::string, std::shared_ptr<CustomSound>> m_soundMap;
